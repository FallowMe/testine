...
def prideti_preke():
    try:
        ...
        with open('prekes.txt', 'a+') as failas:  # a+ atsidaro append rezimas ir galesime po eilute irasyti i faila nauja info
    ...
    try:
        with open(failo_pavadinimas, 'r') as failas:
            ...
            for eilute in eilutes:
                pavadinimas, kaina, kiekis = eilute.replace('\n', '').split()  # suformuos lista kuriame bus 3 nariai
...
while True:      # begalinis ciklas kol vartotojas nesustabdys
    pasirinkimai()
    ...
    if pasirinkimas == '1':
        ...
        print('Pasirinkimas netinkamas, kartokike.')
